...
| `limit` | число строк, `1..200` | `6` |
| `page` | страница, начиная с `0` | `0` |
| `sortBy` | `ticker`, `name`, `price`, `yield`, `volume`, `turnover`, `liquidity`, `maturity`, `volatility`, `marketCap`, `strikePrice` | `ticker` |
| `sortDirection` | `asc`, `desc` | `asc` |
| `minPrice`, `maxPrice` | диапазон цены | без фильтра |
| `minYield`, `maxYield` | диапазон расчетной доходности | без фильтра |
| `minVolume`, `maxVolume` | диапазон объема | без фильтра |
| `minTurnover`, `maxTurnover` | диапазон оборота | без фильтра |
| `minVolatility`, `maxVolatility` | диапазон волатильности | без фильтра |
| `maturityFrom`, `maturityTo` | диапазон даты погашения в формате `YYYY-MM-DD` | без фильтра |
| `minMarketCap`, `maxMarketCap` | диапазон капитализации | без фильтра |
| `optionType` | `CALL` или `PUT` | без фильтра |
| `minStrikePrice`, `maxStrikePrice` | диапазон strike price | без фильтра |
